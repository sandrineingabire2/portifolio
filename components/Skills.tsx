...
export default function Skills() {
  ...
  return (
    <section id="skills" className="min-h-screen flex items-center px-6 py-20 relative overflow-hidden">
      <div className="absolute top-1/4 left-10 w-80 h-80 bg-[#8A9A5B]/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-[#6b9071]/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
      
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="text-center mb-20">
          <p className="text-[#8A9A5B] text-sm font-bold tracking-wider uppercase mb-3">MY FAVORITE TOOLS</p>
          <h2 className="text-5xl lg:text-6xl font-black text-white mb-4">
            Exploring the <span className="text-[#6b9071]">Tools</span>
          </h2>
          <p className="text-gray-400 text-2xl font-light">Behind My Design & Development</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedSkills.map((skill, index) => (
            <div 
              key={skill.name}
              className="group relative glass-effect rounded-2xl p-6 hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:shadow-[#6b9071]/20 overflow-hidden border border-white/5"
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <div className="mb-2 group-hover:scale-125 group-hover:rotate-12 transition-all duration-300 text-white">
                      <SkillIcon name={skill.name} />
                    </div>
                    <h3 className="text-2xl font-black text-white">{skill.name}</h3>
                    <p className="text-[#8A9A5B] text-xs font-semibold mt-1">{skill.category}</p>
                  </div>
                  <div className="text-right">
                    <div className="text-3xl font-black text-[#6b9071]">{skill.level}%</div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-0 left-0 h-3 bg-[#6b9071] rounded-full blur-md opacity-50 transition-all duration-1000" style={{ width: `${skill.level}%` }}></div>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-8 py-3 bg-[#6b9071] text-white rounded-full font-bold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-[#6b9071]/30"
          >
        ...
        <div className="mt-16 text-center">
          <div className="inline-block glass-effect rounded-2xl px-8 py-4 border border-[#8A9A5B]/20">
